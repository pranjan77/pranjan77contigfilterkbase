...
from pranjan77contigfilterkbase.pranjan77contigfilterkbaseImpl import pranjan77contigfilterkbase


class pranjan77contigfilterkbaseTest(unittest.TestCase):

    @classmethod
    def setUpClass(cls):
        token = environ.get('KB_AUTH_TOKEN', None)
        cls.ctx = {'token': token, 'provenance': [{'service': 'pranjan77contigfilterkbase',
        ...
        for nameval in config.items('pranjan77contigfilterkbase'):
            cls.cfg[nameval[0]] = nameval[1]
        cls.wsURL = cls.cfg['workspace-url']
        cls.wsClient = workspaceService(cls.wsURL, token=token)
        cls.serviceImpl = pranjan77contigfilterkbase(cls.cfg)
    ...
    def getWsName(self):
        ...
        wsName = "test_pranjan77contigfilterkbase_" + str(suffix)
    ...
    def test_filter_contigs_ok(self):
        ...
        contig3 = {'id': '3', 'length': 16, 'md5': 'md5', 'sequence': 'agcttttcatggaaaa'}
