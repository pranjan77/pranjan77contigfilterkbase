...
def get_config():
    ...
    for nameval in config.items(get_service_name() or 'pranjan77contigfilterkbase'):
...
impl_pranjan77contigfilterkbase = pranjan77contigfilterkbase(config)
...
class Application(object):
    ...
    def __init__(self):
        submod = get_service_name() or 'pranjan77contigfilterkbase'
        ...
        self.rpc_service.add(impl_pranjan77contigfilterkbase.filter_contigs,
                    ...
                    if auth_req != "none":
                        if token is None and auth_req == 'required':
                            ...
                            err.data = "Authentication required for " + \
                                "pranjan77contigfilterkbase but no authentication header was passed"
                            raise err
