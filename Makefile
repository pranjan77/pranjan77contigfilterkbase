SERVICE = pranjan77contigfilterkbase
SERVICE_CAPS = pranjan77contigfilterkbase
SPEC_FILE = pranjan77contigfilterkbase.spec
URL = https://kbase.us/services/pranjan77contigfilterkbase
DIR = $(shell pwd)
LIB_DIR = lib
SCRIPTS_DIR = scripts
TEST_DIR = test
